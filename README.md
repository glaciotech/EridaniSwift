...
- **Allow for approval or denial of requested tool execution**
...
- **AI services**: Provider-specific connectors for remote LLM services. These create LLMs for OpenAI, Anthropic, xAI, and Inception as well as local LLM services (coming soon), running on device.
...
See the ToolUsingAgentExample in the example projects for a complete example implementation [`Examples/EridaniAppExamples.xcodeproj`](Examples/EridaniAppExamples.xcodeproj).
...
You can also configure keys as launch args in your app’s scheme:
